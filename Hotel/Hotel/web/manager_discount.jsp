...
<html lang="en">
    ...
    <body>
            ...
            <table style="margin-top: 20px;margin-bottom: 20px;" id="booking">
                ...
                <c:forEach items="${sessionScope.listD}" var="l">
                    <tr>
                        ...
                        <td>${l.getNote()}</td>
                        <td>
                            <a href="edit?IDDiscount=${l.getIDDiscount()}">Edit</a> | 
                            <a href="delete?IDDiscount=${l.getIDDiscount()}" onclick="return confirm('Are you sure you want to delete this discount?')">Delete</a>
                        </td>
                    </tr>
                </c:forEach>
            </table>
        ...
        <!-- Modal (Popup) for Adding New Discount -->
                    ...
                    <div class="modal-body">
                        <form action="addNewDiscount" method="get">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="StartDay" placeholder="YYYY-MM-DD" required>
                            </div>
                            <div class="form-group">
                                <label>End Day</label>
                                <input type="text" class="form-control" name="EndDay" placeholder="YYYY-MM-DD" required>
                            </div>
